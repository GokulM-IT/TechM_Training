 ...
 */
package com.firstRun.core.models;
...
import com.firstRun.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "firstRun/components/helloworld");
