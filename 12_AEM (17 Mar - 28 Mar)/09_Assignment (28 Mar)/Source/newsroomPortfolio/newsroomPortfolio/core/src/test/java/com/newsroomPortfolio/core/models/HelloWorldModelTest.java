 ...
 */
package com.newsroomPortfolio.core.models;
...
import com.newsroomPortfolio.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "newsroomPortfolio/components/helloworld");
